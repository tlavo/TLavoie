...
function Education() {
  return (
    <div className="comp_item comp_item--end scrollable" id="Description">
      ...
      <div className="e-list">
        <div className="e-item">
          <div className="e-details">
            <strong>BSc in Software Engineering</strong> <br />
      ...
      <h2 className="space">Achievements</h2>
      <div className="e-list">
        <div className="e-item">
          <div className="e-details">
            <strong>
        ...
        <div className="e-item">
          <div className="e-details">
            <strong>Jason Lang Scholarship</strong> <br />
            University of Calgary
          </div>
          <div className="e-dates">
            Fall Term 2023 <br />
        ...
        <div className="e-item">
          <div className="e-details">
            <strong>Indigenous Careers Award</strong> <br />
            University of Calgary
          </div>
          <div className="e-dates">
            2022-2023 <br />
